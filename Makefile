...
build/asm/c_main.s: src/main.c build/include/scenarios.h
	cc65 -Oir $(INCLUDES) $< -g -o $@ 
...
build/asm/scenarios.s build/include/scenarios.h: script/compile_scenarios.php src/scenarios.txt
	./script/compile_scenarios.php
